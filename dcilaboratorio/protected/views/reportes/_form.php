...
<div class="portlet box blue">
	...
	<div class="portlet-body form" style="display: block;">
		...
		<div class="form-body">
			...
			<div class="row">
				<div class="form-group col-md-3 <?php if($form->error($model,'diadia')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'mes')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'año')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'semana')!=''){ echo 'has-error'; }?>">
			...
			<div class="row">
				<div class="form-group col-md-3 <?php if($form->error($model,'hora')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'folio')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'id_paciente')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'nombre_paciente')!=''){ echo 'has-error'; }?>">
			...
			<div class="row">
				<div class="form-group col-md-3 <?php if($form->error($model,'unidad')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'doctor')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'id_examen')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'costo')!=''){ echo 'has-error'; }?>">
			...
			<div class="row">
				<div class="form-group col-md-3 <?php if($form->error($model,'porcentaje_descuento')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'monto_descuento')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-3 <?php if($form->error($model,'tarifa')!=''){ echo 'has-error'; }?>">
