...
<div class="portlet box blue">
	...
	<div class="portlet-body form" style="display: block;">
		...
		<div class="form-body">
			<div class="row fechas-filters">
				<div class="form-group col-md-6  <?php if($form->error($model,'fecha_inicial')!=''){ echo 'has-error'; }?>">
				...
				<div class="form-group col-md-6  <?php if($form->error($model,'fecha_final')!=''){ echo 'has-error'; }?>">
			...
			<div class="row">
				<div class="form-group col-md-12 <?php if($form->error($model,'id_multitarifarios')!=''){ echo 'has-error'; }?>">
					<?php echo $form->labelEx($model,'id_multitarifarios', array('class'=>'control-label')); ?>
					<div class="input-group">
						<?php echo $form->dropDownList($model,'id_multitarifarios',Multitarifarios::model()->selectList(), array('class'=>'form-control select2me')); ?>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="input-group">
						<?php echo $form->dropDownList($model,'id_pacientes',Pacientes::model()->selectListWithMail(), array("empty"=>"Seleccione un paciente", 'class'=>'form-control select2me')); ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12<?php if($form->error($model,'id_doctores')!=''){ echo 'has-error'; }?>">
					<?php echo $form->labelEx($model,'id_doctores', array('class'=>'control-label')); ?>
					<div class="input-group">
						<?php echo $form->dropDownList($model,'id_doctores',Doctores::model()->selectList(), array('class'=>'form-control select2me','onchange' => 'javascript:$("#compartirDr").toggle()')); ?>
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="input-group">
						<?php echo $form->dropDownList($model,'clave_examen', Examenes::model()->selectListWithClave(), array('class'=>'form-control select2me')); ?>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="input-group">
						<?php echo $form->dropDownList($model,'estatus', Status::model()->selectList(), array('class'=>'form-control select2me')); ?>
					</div>
				</div>
			</div>
			<hr/>
			...
			<div class="check-filters">
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'diadia')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'mes')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'año')!=''){ echo 'has-error'; }?>">
				...
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'semana')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'hora')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'folio')!=''){ echo 'has-error'; }?>">
				...
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'id_paciente')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'nombre_paciente')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'unidad')!=''){ echo 'has-error'; }?>">
				...
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'doctor')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'id_examen')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'costo')!=''){ echo 'has-error'; }?>">
				...
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'porcentaje_descuento')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'monto_descuento')!=''){ echo 'has-error'; }?>">
					...
					<div class="form-group col-md-4 <?php if($form->error($model,'tarifa')!=''){ echo 'has-error'; }?>">
				...
				<div class="row">
					<div class="form-group col-md-4 <?php if($form->error($model,'id_estatus')!=''){ echo 'has-error'; }?>">
