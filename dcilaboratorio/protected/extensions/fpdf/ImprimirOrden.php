...
class ImprimirOrden extends FPDF{
	...
	function Header(){
		...
		$this->Image(dirname(__FILE__).DIRECTORY_SEPARATOR.'../../../css\layout\img/gvia_logo22.png',1.5,1.5,2,2);
    // Move to the right
    //$this->Cell(8);
    // Title
		$this->SetXY(4, 1);
	...
	function cabeceraHorizontal($model)
	{
        ...
        $this->Cell(2,$y,$model->fecha_captura, 0, 1);
        $this->setX(1);
    ...
    function contenido($model){
        ...
        $this->ln(1);
        $this->Cell(10,$y,'Puede consultar sus resultados por Internet en la siguente liga:', 0, 1);
        $this->Cell(10,$y,'www.dcilaboratorio.com', 0, 1);
